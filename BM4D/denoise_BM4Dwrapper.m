function [y_est, sigmaEst, PSNR, SSIM] = denoise_BM4Dwrapper(y, logConvert)
    ...
    if logConvert == 1
        ...
        disp('Converting to LOG domain before denoising (if your noise is multiplicative')
        
        epsilon = 0.0001; % to avoid zeros
        ...
        disp('Filtering in linear domain (if your noise is additive).')
        % For Poisson / Rice noise, you would need the Anscombe transform
